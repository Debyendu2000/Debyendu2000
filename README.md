...
- Successfully completed a 6-month internship as an AI/ML Engineer.
- Developed and deployed Machine Learning and Generative AI solutions.
- Worked on Retrieval-Augmented Generation (RAG), Large Language Models (LLMs), and Agentic AI applications.
- Built AI-powered systems using Python, LangChain, Vector Databases, and modern AI frameworks.
- Gained hands-on experience in model development, data processing, evaluation, and deployment workflows.
